...
module.exports = function(app) {
  ...
  addvehicle = function(req, res) {
    ...
    //Generamos una instancia de la bbdd
    let vehicle = new Vehicle({
      //tomamos los valores que vienen como parametro
   ...
   */
   ...
   //Para poder actualizar, primero se debe encontrar el vehiculo por ID
  updatevehicle = function(req, res) {
    ...
    return Vehicle.findById(req.params.id, function(err, vehicle) {
      ...
      //Si son diferentes de nulos se actualizan los valores
 ...
 //Asociamos las funciones de la clase a las urls
